...
class Digital_waveformsList(object):
    ...
    def __setitem__(self, key, value: dict):
        import opx_control.quam_sdk.crud
...
class Twpa_pump(object):
    ...
    def address(self) -> str:
        ...
        value = self._quam._json[self._path + "address"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def address(self, value: str):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "address")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "address"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "address"] = value
...
class Readout_line(object):
    ...
    @property
    def flattop_plateau(self) -> float:
        """Flattop readout plateau duration [s]."""
        
        value = self._quam._json[self._path + "flattop_plateau"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @flattop_plateau.setter
    def flattop_plateau(self, value: float):
        """Flattop readout plateau duration [s]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_plateau")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_plateau"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_plateau"] = value

    @property
    def flattop_rise(self) -> float:
        """Flattop readout rise duration [s]."""
        
        value = self._quam._json[self._path + "flattop_rise"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @flattop_rise.setter
    def flattop_rise(self, value: float):
        """Flattop readout rise duration [s]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_rise")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_rise"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_rise"] = value

    @property
    def flattop_fall(self) -> float:
        """Flattop readout fall duration [s]."""
        
        value = self._quam._json[self._path + "flattop_fall"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @flattop_fall.setter
    def flattop_fall(self, value: float):
        """Flattop readout fall duration [s]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_fall")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_fall"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_fall"] = value

    @property
    def flattop_amplitude(self) -> float:
        """Flattop readout amplitude [V]."""
        
        value = self._quam._json[self._path + "flattop_amplitude"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @flattop_amplitude.setter
    def flattop_amplitude(self, value: float):
        """Flattop readout amplitude [V]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_amplitude")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_amplitude"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_amplitude"] = value

    @property
    def flattop_wait(self) -> float:
        """Flattop readout wait duration [s]."""
        
        value = self._quam._json[self._path + "flattop_wait"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @flattop_wait.setter
    def flattop_wait(self, value: float):
        """Flattop readout wait duration [s]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_wait")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_wait"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_wait"] = value

    @property
    def flattop_wait_after(self) -> float:
        """Wait duration after flattop pulse [s]."""
        
        value = self._quam._json[self._path + "flattop_wait_after"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @flattop_wait_after.setter
    def flattop_wait_after(self, value: float):
        """Wait duration after flattop pulse [s]."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_wait_after")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_wait_after"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_wait_after"] = value

    @property
    def flattop_shape(self) -> str:
        """"""
        
        value = self._quam._json[self._path + "flattop_shape"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @flattop_shape.setter
    def flattop_shape(self, value: str):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flattop_shape")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flattop_shape"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flattop_shape"] = value
    ...
    @property
    def twpa_pump(self) -> Twpa_pump:
        """"""
        return Twpa_pump(
            self._quam, self._path + "twpa_pump/", self._index,
            self._schema["properties"]["twpa_pump"]
        )
    @twpa_pump.setter
    def twpa_pump(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "twpa_pump", value)
        ...
        """Adds a new readout_line by adding a JSON dictionary with following schema
{
  ...
  "flattop_plateau": {
    "type": "number",
    "description": "Flattop readout plateau duration [s]."
  },
  "flattop_rise": {
    "type": "number",
    "description": "Flattop readout rise duration [s]."
  },
  "flattop_fall": {
    "type": "number",
    "description": "Flattop readout fall duration [s]."
  },
  "flattop_amplitude": {
    "type": "number",
    "description": "Flattop readout amplitude [V]."
  },
  "flattop_wait": {
    "type": "number",
    "description": "Flattop readout wait duration [s]."
  },
  "flattop_wait_after": {
    "type": "number",
    "description": "Wait duration after flattop pulse [s]."
  },
  "flattop_shape": {
    "type": "string"
  },
  "twpa_pump": {
    ...
    "properties": {
      ...
      "freq": {
        "type": "number",
        "description": "Pump frequency [Hz]."
      },
      "power": {
        "type": "number",
        "description": "Pump power [dBm]."
      },
      "address": {
        "type": "string"
      }
...
class Readout_resonator(object):
    ...
    @property
    def f_opt_12(self) -> float:
        """Resonator optimal readout frequency [Hz] for the 2nd excited state (used in QUA)."""
        
        value = self._quam._json[self._path + "f_opt_12"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @f_opt_12.setter
    def f_opt_12(self, value: float):
        """Resonator optimal readout frequency [Hz] for the 2nd excited state (used in QUA)."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "f_opt_12")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "f_opt_12"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "f_opt_12"] = value
    ...
    @threshold_I.setter
    def threshold_I(self, value: float):
        """Threshold (in demod unit) along the 'I' quadrature discriminating between qubit ground and excited states."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "threshold_I")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "threshold_I"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "threshold_I"] = value

    @property
    def threshold_Q(self) -> float:
        """Threshold (in demod unit) along the 'Q' quadrature discriminating between qubit first and second excited states."""
        
        value = self._quam._json[self._path + "threshold_Q"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @threshold_Q.setter
    def threshold_Q(self, value: float):
        """Threshold (in demod unit) along the 'Q' quadrature discriminating between qubit first and second excited states."""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "threshold_Q")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "threshold_Q"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "threshold_Q"] = value

    @property
    def state_centers_I(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "state_centers_I",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "state_centers_I"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @state_centers_I.setter
    def state_centers_I(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "state_centers_I")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "state_centers_I"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "state_centers_I"] = value

    @property
    def state_centers_Q(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "state_centers_Q",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "state_centers_Q"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @state_centers_Q.setter
    def state_centers_Q(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "state_centers_Q")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "state_centers_Q"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "state_centers_Q"] = value

    @property
    def state_radii(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "state_radii",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "state_radii"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @state_radii.setter
    def state_radii(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "state_radii")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "state_radii"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "state_radii"] = value
        ...
        """Adds a new readout_resonator by adding a JSON dictionary with following schema
{
  ...
  "f_opt_12": {
    "type": "number",
    "description": "Resonator optimal readout frequency [Hz] for the 2nd excited state (used in QUA)."
  },
  "readout_regime": {
    "type": "string"
  },
  ...
  "threshold_Q": {
    "type": "number",
    "description": "Threshold (in demod unit) along the 'Q' quadrature discriminating between qubit first and second excited states."
  },
  "state_centers_I": {
    "type": "array",
    "items": {
    ...
    "description": "Centers of the qubit ground and excited states along the 'I' quadrature."
  },
  "state_centers_Q": {
    "type": "array",
    "items": {
    ...
    "description": "Centers of the qubit ground and excited states along the 'Q' quadrature."
  },
  "state_radii": {
    "type": "array",
    "items": {
    ...
    "description": "Radii of the qubit ground and excited states in the IQ plane."
  },
  "readout_fidelity": {
    "type": "number"
  },
...
class Drive_line(object):
    ...
    @property
    def lo_power(self) -> int:
        """LO output, if 1 the output is on, if 0 the output is off"""
    ...
    @property
    def lo_output(self) -> int:
        """"""
        
        value = self._quam._json[self._path + "lo_output"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @lo_output.setter
    def lo_output(self, value: int):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "lo_output")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "lo_output"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "lo_output"] = value
        ...
        """Adds a new drive_line by adding a JSON dictionary with following schema
{
  ...
  "lo_output": {
    "type": "integer",
    "description": "LO output, if 1 the output is on, if 0 the output is off"
  },
  "I": {
    "type": "object",
    "title": "I",
...
class Frequency_domain_ramsey(object):
    ...
    def phi(self) -> float:
        ...
        value = self._quam._json[self._path + "phi"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def phi(self, value: float):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "phi")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "phi"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "phi"] = value
    ...
    def __eq__(self, other):
        if isinstance(other, Frequency_domain_ramsey):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Two_point_ramsey(object):
    ...
    @property
    def two_point_difference(self) -> float:
        """Signal difference between the two points [Hz]"""
        
        value = self._quam._json[self._path + "two_point_difference"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @two_point_difference.setter
    def two_point_difference(self, value: float):
        """Signal difference between the two points [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "two_point_difference")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "two_point_difference"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "two_point_difference"] = value

    @property
    def frequency_domain_detuning(self) -> float:
        """Detuning for the frequency domain Ramsey and two-point Ramsey experiments [Hz]"""
        
        value = self._quam._json[self._path + "frequency_domain_detuning"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @frequency_domain_detuning.setter
    def frequency_domain_detuning(self, value: float):
        """Detuning for the frequency domain Ramsey and two-point Ramsey experiments [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "frequency_domain_detuning")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "frequency_domain_detuning"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "frequency_domain_detuning"] = value

    @property
    def time_domain_wait_time(self) -> float:
        """First peak location in the time domain Ramsey experiment [s]"""
        
        value = self._quam._json[self._path + "time_domain_wait_time"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @time_domain_wait_time.setter
    def time_domain_wait_time(self, value: float):
        """First peak location in the time domain Ramsey experiment [s]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "time_domain_wait_time")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "time_domain_wait_time"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "time_domain_wait_time"] = value

    @property
    def frequency_domain_ramsey(self) -> Frequency_domain_ramsey:
        """Fit arameters from the frequency domain Ramsey experiment"""
        return Frequency_domain_ramsey(
            self._quam, self._path + "frequency_domain_ramsey/", self._index,
            self._schema["properties"]["frequency_domain_ramsey"]
        )
    @frequency_domain_ramsey.setter
    def frequency_domain_ramsey(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "frequency_domain_ramsey", value)
    ...
    def __eq__(self, other):
        if isinstance(other, Two_point_ramsey):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Transmon_spectrum(object):
    ...
    def max_freq(self) -> float:
        """Maximum frequency of the transmon spectrum [Hz]"""
        
        value = self._quam._json[self._path + "max_freq"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def max_freq(self, value: float):
        """Maximum frequency of the transmon spectrum [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "max_freq")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "max_freq"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "max_freq"] = value

    @property
    def Ec(self) -> float:
        """Charging energy [Hz]"""
        
        value = self._quam._json[self._path + "Ec"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def Ec(self, value: float):
        """Charging energy [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "Ec")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "Ec"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "Ec"] = value

    @property
    def d(self) -> int:
        """Asymmmetry of the transmon spectrum [Hz]"""
        
        value = self._quam._json[self._path + "d"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def d(self, value: int):
        """Asymmmetry of the transmon spectrum [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "d")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "d"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "d"] = value

    @property
    def v_per_phi0(self) -> float:
        """Period of transmon spectrum in volts [V]"""
        
        value = self._quam._json[self._path + "v_per_phi0"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @v_per_phi0.setter
    def v_per_phi0(self, value: float):
        """Period of transmon spectrum in volts [V]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "v_per_phi0")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "v_per_phi0"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "v_per_phi0"] = value

    @property
    def flux_offset(self) -> int:
        """Flux offset [Phi_0]"""
        
        value = self._quam._json[self._path + "flux_offset"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @flux_offset.setter
    def flux_offset(self, value: int):
        """Flux offset [Phi_0]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "flux_offset")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "flux_offset"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "flux_offset"] = value
    ...
    def __eq__(self, other):
        if isinstance(other, Transmon_spectrum):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Drag_cosine_f12(object):
    ...
    def __eq__(self, other):
        if isinstance(other, Drag_cosine_f12):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Angle2volt5(object):
    ...
    def __eq__(self, other):
        if isinstance(other, Angle2volt5):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Driving(object):
    ...
    @property
    def drag_cosine_f12(self) -> Drag_cosine_f12:
        """"""
        return Drag_cosine_f12(
            self._quam, self._path + "drag_cosine_f12/", self._index,
            self._schema["properties"]["drag_cosine_f12"]
        )
    @drag_cosine_f12.setter
    def drag_cosine_f12(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "drag_cosine_f12", value)
...
class Qubit(object):
    ...
    def f_12(self) -> float:
        ...
        value = self._quam._json[self._path + "f_12"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @f_12.setter
    def f_12(self, value: float):
        """1-2 transition frequency [Hz]"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "f_12")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "f_12"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "f_12"] = value
    ...
    @property
    def t2echo(self) -> float:
        """Dephasing time T2 echo [s]"""
    ...
    @property
    def two_point_ramsey(self) -> Two_point_ramsey:
        """Information from the two point Ramsey experiment (for active qubit frequency correction on the OP-X)"""
        return Two_point_ramsey(
            self._quam, self._path + "two_point_ramsey/", self._index,
            self._schema["properties"]["two_point_ramsey"]
        )
    @two_point_ramsey.setter
    def two_point_ramsey(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "two_point_ramsey", value)
    
    @property
    def transmon_spectrum(self) -> Transmon_spectrum:
        """"""
        return Transmon_spectrum(
            self._quam, self._path + "transmon_spectrum/", self._index,
            self._schema["properties"]["transmon_spectrum"]
        )
    @transmon_spectrum.setter
    def transmon_spectrum(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "transmon_spectrum", value)
        ...
        """Adds a new qubit by adding a JSON dictionary with following schema
{
  ...
  "f_12": {
    "type": "number",
    "description": "1-2 transition frequency [Hz]"
  },
  "anharmonicity": {
    "type": "number",
  ...
  "t2echo": {
    "type": "number",
    "description": "Dephasing time T2 echo [s]"
  },
  "t2star": {
    "type": "number",
    "description": "Dephasing time T2* [s]"
  ...
  "two_point_ramsey": {
    "type": "object",
    "title": "two_point_ramsey",
    "properties": {
      "frequency_domain_ramsey": {
        "type": "object",
        "title": "frequency_domain_ramsey",
        "properties": {
          "amplitude": {
            "type": "number"
          },
      ...
      "two_point_difference": {
        "type": "number",
        "description": "Signal difference between the two points [Hz]"
      },
      "frequency_domain_detuning": {
        "type": "number",
        "description": "Detuning for the frequency domain Ramsey and two-point Ramsey experiments [Hz]"
      },
      "time_domain_wait_time": {
        "type": "number",
        "description": "First peak location in the time domain Ramsey experiment [s]"
      }
    },
    "required": [
      "frequency_domain_ramsey",
  ...
  "transmon_spectrum": {
    "type": "object",
    "title": "transmon_spectrum",
    "properties": {
      "max_freq": {
        "type": "number",
        "description": "Maximum frequency of the transmon spectrum [Hz]"
      },
      "Ec": {
        "type": "number",
        "description": "Charging energy [Hz]"
      },
      "d": {
        "type": "integer",
        "description": "Asymmmetry of the transmon spectrum [Hz]"
      },
      "v_per_phi0": {
        "type": "number",
        "description": "Period of transmon spectrum in volts [V]"
      },
      "flux_offset": {
        "type": "integer",
        "description": "Flux offset [Phi_0]"
      }
    },
    "required": [
      "max_freq",
...
class Flux_bias_lookup_table(object):
    ...
    @property
    def dc_offset(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "dc_offset",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "dc_offset"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @dc_offset.setter
    def dc_offset(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "dc_offset")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "dc_offset"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "dc_offset"] = value

    @property
    def f_01(self) -> List[Union[str, int, float, bool, list]]:
        """"""
    ...
    @f_01.setter
    def f_01(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "f_01")
            self._quam._updates["indexes"].append(self._index)
    ...
    @property
    def resonator_frequency(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "resonator_frequency",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "resonator_frequency"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value


    @resonator_frequency.setter
    def resonator_frequency(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "resonator_frequency")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "resonator_frequency"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "resonator_frequency"] = value

    @property
    def pi_amplitude(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "pi_amplitude",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "pi_amplitude"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @pi_amplitude.setter
    def pi_amplitude(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "pi_amplitude")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "pi_amplitude"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "pi_amplitude"] = value

    @property
    def readout_frequency(self) -> List[Union[str, int, float, bool, list]]:
        """"""
        
        if self._quam._record_updates:
            return _List(
                self._quam,
                self._path + "readout_frequency",
                self._index,
                self._schema
            )
        
        value = self._quam._json[self._path + "readout_frequency"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def readout_frequency(self, value: List[Union[str, int, float, bool, list]]):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "readout_frequency")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "readout_frequency"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "readout_frequency"] = value
    ...
    def __eq__(self, other):
        if isinstance(other, Flux_bias_lookup_table):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class Flux_bias_lookup_tableList(object):
    ...
    def __getitem__(self, key) -> Flux_bias_lookup_table:
        return Flux_bias_lookup_table(
            self._quam,
            self._path + "[]/",
            self._index + [key],
            self._schema["items"]
    ...
    def append(self, json_item:dict):
        """Adds a new flux_bias_lookup_table by adding a JSON dictionary with following schema
{
  "dc_offset": {
    "type": "array",
    "items": {
...
class Noise_pulses(object):
    ...
    def n_pulses(self) -> int:
        ...
        value = self._quam._json[self._path + "n_pulses"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @n_pulses.setter
    def n_pulses(self, value: int):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "n_pulses")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "n_pulses"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "n_pulses"] = value
    ...
    def bandwidth(self) -> float:
        ...
        value = self._quam._json[self._path + "bandwidth"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def bandwidth(self, value: float):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "bandwidth")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "bandwidth"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "bandwidth"] = value

    @property
    def seed(self) -> int:
        """"""
        
        value = self._quam._json[self._path + "seed"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def seed(self, value: int):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "seed")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "seed"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "seed"] = value
    ...
    def __eq__(self, other):
        if isinstance(other, Noise_pulses):
            return f"{self._path}{self._index}" == f"{other._path}{other._index}"
        return NotImplemented
...
class QuAM(object):
    ...
    def __init__(self, flat_json: Union[None, str, dict] = None):
        ...
        self._schema_flat = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'name': 'QuAM storage format', 'description': 'optimized data structure for communication and storage', 'type': 'object', 'properties': {'digital_waveforms[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'readout_lines[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'readout_resonators[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'readout_resonators[]/integration_weights[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'drive_lines[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'qubits[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'qubits[]/flux_bias_points[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'qubits[]/sequence_states/constant[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'qubits[]/sequence_states/arbitrary[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'flux_bias_lookup_table[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'single_qubit_operations[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}, 'two_qubit_gates/CZ[]_len': {'anyof': [{'type': 'array'}, {'type': 'integer'}]}}, 'additionalProperties': False}
        self._schema = {'$schema': 'https://json-schema.org/draft/2020-12/schema', 'type': 'object', 'title': 'QuAM', 'properties': {'network': {'type': 'object', 'title': 'network', 'properties': {'qop_ip': {'type': 'string'}, 'port': {'type': 'integer'}}, 'required': ['qop_ip', 'port']}, 'controllers': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'digital_waveforms': {'type': 'array', 'items': {'type': 'object', 'title': 'digital_waveform', 'properties': {'name': {'type': 'string'}, 'samples': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['name', 'samples']}}, 'common_operation': {'type': 'object', 'title': 'common_operation', 'description': 'an operation which is common to all elements', 'properties': {'name': {'type': 'string'}, 'duration': {'type': 'number', 'description': 'pulse length [s]'}, 'amplitude': {'type': 'number', 'description': 'pulse amplitude [V]'}}, 'required': ['name', 'duration', 'amplitude']}, 'readout_lines': {'type': 'array', 'items': {'type': 'object', 'title': 'readout_line', 'properties': {'length': {'type': 'number', 'description': 'readout time on this readout line [s]'}, 'lo_freq': {'type': 'number', 'description': 'LO frequency for readout line [Hz]'}, 'lo_power': {'type': 'integer', 'description': 'LO power for readout line [dBm]'}, 'I_up': {'type': 'object', 'title': 'I_up', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}}, 'required': ['controller', 'channel', 'offset']}, 'Q_up': {'type': 'object', 'title': 'Q_up', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}}, 'required': ['controller', 'channel', 'offset']}, 'I_down': {'type': 'object', 'title': 'I_down', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}, 'gain_db': {'type': 'integer'}}, 'required': ['controller', 'channel', 'offset', 'gain_db']}, 'Q_down': {'type': 'object', 'title': 'Q_down', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}, 'gain_db': {'type': 'integer'}}, 'required': ['controller', 'channel', 'offset', 'gain_db']}, 'flattop_plateau': {'type': 'number', 'description': 'Flattop readout plateau duration [s].'}, 'flattop_rise': {'type': 'number', 'description': 'Flattop readout rise duration [s].'}, 'flattop_fall': {'type': 'number', 'description': 'Flattop readout fall duration [s].'}, 'flattop_amplitude': {'type': 'number', 'description': 'Flattop readout amplitude [V].'}, 'flattop_wait': {'type': 'number', 'description': 'Flattop readout wait duration [s].'}, 'flattop_wait_after': {'type': 'number', 'description': 'Wait duration after flattop pulse [s].'}, 'flattop_shape': {'type': 'string'}, 'twpa_pump': {'type': 'object', 'title': 'twpa_pump', 'properties': {'name': {'type': 'string'}, 'freq': {'type': 'number', 'description': 'Pump frequency [Hz].'}, 'power': {'type': 'number', 'description': 'Pump power [dBm].'}, 'address': {'type': 'string'}}, 'required': ['name', 'freq', 'power', 'address']}}, 'required': ['length', 'lo_freq', 'lo_power', 'I_up', 'Q_up', 'I_down', 'Q_down', 'flattop_plateau', 'flattop_rise', 'flattop_fall', 'flattop_amplitude', 'flattop_wait', 'flattop_wait_after', 'flattop_shape', 'twpa_pump']}}, 'readout_resonators': {'type': 'array', 'items': {'type': 'object', 'title': 'readout_resonator', 'properties': {'index': {'type': 'integer'}, 'name': {'type': 'string'}, 'f_res': {'type': 'number', 'description': 'Resonator resonance frequency [Hz].'}, 'f_opt': {'type': 'number', 'description': 'Resonator optimal readout frequency [Hz] (used in QUA).'}, 'f_opt_12': {'type': 'number', 'description': 'Resonator optimal readout frequency [Hz] for the 2nd excited state (used in QUA).'}, 'readout_regime': {'type': 'string'}, 'readout_amplitude': {'type': 'number', 'description': 'Readout amplitude for this resonator [V]. Must be within [-0.5, 0.5).'}, 'rotation_angle': {'type': 'number', 'description': "Angle by which to rotate the IQ blobs to place the separation along the 'I' quadrature [degrees]."}, 'integration_weights': {'type': 'array', 'items': {'type': 'object', 'title': 'integration_weight', 'properties': {'name': {'type': 'string'}, 'cosine': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'sine': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['name', 'cosine', 'sine']}, 'description': 'Arbitrary integration weights defined as lists of tuples whose first element is the value of the integration weight and second element is the duration in ns for which this value should be used [(1.0, readout_len)]. The duration must be divisible by 4.'}, 'threshold_I': {'type': 'number', 'description': "Threshold (in demod unit) along the 'I' quadrature discriminating between qubit ground and excited states."}, 'threshold_Q': {'type': 'number', 'description': "Threshold (in demod unit) along the 'Q' quadrature discriminating between qubit first and second excited states."}, 'state_centers_I': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': "Centers of the qubit ground and excited states along the 'I' quadrature."}, 'state_centers_Q': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': "Centers of the qubit ground and excited states along the 'Q' quadrature."}, 'state_radii': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': 'Radii of the qubit ground and excited states in the IQ plane.'}, 'readout_fidelity': {'type': 'number'}, 'q_factor': {'type': 'number'}, 'chi': {'type': 'number'}, 'relaxation_time': {'type': 'number', 'description': 'Resonator relaxation time [s].'}, 'f_res_vs_flux': {'type': 'object', 'title': 'f_res_vs_flux', 'properties': {'a': {'type': 'number'}, 'b': {'type': 'number'}, 'c': {'type': 'number'}}, 'required': ['a', 'b', 'c']}, 'wiring': {'type': 'object', 'title': 'wiring', 'properties': {'readout_line_index': {'type': 'integer', 'description': 'Index of the readout line connected to this resonator.'}, 'time_of_flight': {'type': 'integer', 'description': 'Time of flight for this resonator [ns].'}, 'smearing': {'type': 'number', 'description': 'Smearing of the readout window [ns].'}, 'correction_matrix': {'type': 'object', 'title': 'correction_matrix', 'properties': {'gain': {'type': 'number'}, 'phase': {'type': 'number'}}, 'required': ['gain', 'phase']}, 'maximum_amplitude': {'type': 'number', 'description': 'max amplitude in volts above which the mixer will send higher harmonics.'}}, 'required': ['readout_line_index', 'time_of_flight', 'smearing', 'correction_matrix', 'maximum_amplitude']}}, 'required': ['index', 'name', 'f_res', 'f_opt', 'f_opt_12', 'readout_regime', 'readout_amplitude', 'rotation_angle', 'integration_weights', 'threshold_I', 'threshold_Q', 'state_centers_I', 'state_centers_Q', 'state_radii', 'readout_fidelity', 'q_factor', 'chi', 'relaxation_time', 'f_res_vs_flux', 'wiring']}}, 'drive_lines': {'type': 'array', 'items': {'type': 'object', 'title': 'drive_line', 'properties': {'qubits': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': 'qubits associated with this drive line'}, 'lo_freq': {'type': 'number', 'description': 'LO frequency [Hz]'}, 'lo_power': {'type': 'integer', 'description': 'LO power to drive line [dBm]'}, 'lo_output': {'type': 'integer', 'description': 'LO output, if 1 the output is on, if 0 the output is off'}, 'I': {'type': 'object', 'title': 'I', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}}, 'required': ['controller', 'channel', 'offset']}, 'Q': {'type': 'object', 'title': 'Q', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}}, 'required': ['controller', 'channel', 'offset']}}, 'required': ['qubits', 'lo_freq', 'lo_power', 'lo_output', 'I', 'Q']}}, 'qubits': {'type': 'array', 'items': {'type': 'object', 'title': 'qubit', 'properties': {'index': {'type': 'integer'}, 'name': {'type': 'string'}, 'f_01': {'type': 'number', 'description': '0-1 transition frequency [Hz]'}, 'f_12': {'type': 'number', 'description': '1-2 transition frequency [Hz]'}, 'anharmonicity': {'type': 'number', 'description': 'Qubit anharmonicity: difference in energy between the 2-1 and the 1-0 energy levels [Hz]'}, 'rabi_freq': {'type': 'integer', 'description': 'Qubit Rabi frequency [Hz]'}, 'rabi_conversion_factor': {'type': 'number', 'description': 'Conversion factor between Rabi frequency and pulse amplitude [Hz/V]'}, 't1': {'type': 'number', 'description': 'Relaxation time T1 [s]'}, 't2': {'type': 'number', 'description': 'Dephasing time T2 [s]'}, 't2echo': {'type': 'number', 'description': 'Dephasing time T2 echo [s]'}, 't2star': {'type': 'number', 'description': 'Dephasing time T2* [s]'}, 'ramsey_det': {'type': 'number', 'description': 'Detuning to observe ramsey fringes [Hz]'}, 'two_point_ramsey': {'type': 'object', 'title': 'two_point_ramsey', 'properties': {'frequency_domain_ramsey': {'type': 'object', 'title': 'frequency_domain_ramsey', 'properties': {'amplitude': {'type': 'number'}, 'frequency': {'type': 'number'}, 'phi': {'type': 'number'}, 'offset': {'type': 'number'}}, 'required': ['amplitude', 'frequency', 'phi', 'offset']}, 'two_point_difference': {'type': 'number', 'description': 'Signal difference between the two points [Hz]'}, 'frequency_domain_detuning': {'type': 'number', 'description': 'Detuning for the frequency domain Ramsey and two-point Ramsey experiments [Hz]'}, 'time_domain_wait_time': {'type': 'number', 'description': 'First peak location in the time domain Ramsey experiment [s]'}}, 'required': ['frequency_domain_ramsey', 'two_point_difference', 'frequency_domain_detuning', 'time_domain_wait_time']}, 'transmon_spectrum': {'type': 'object', 'title': 'transmon_spectrum', 'properties': {'max_freq': {'type': 'number', 'description': 'Maximum frequency of the transmon spectrum [Hz]'}, 'Ec': {'type': 'number', 'description': 'Charging energy [Hz]'}, 'd': {'type': 'integer', 'description': 'Asymmmetry of the transmon spectrum [Hz]'}, 'v_per_phi0': {'type': 'number', 'description': 'Period of transmon spectrum in volts [V]'}, 'flux_offset': {'type': 'integer', 'description': 'Flux offset [Phi_0]'}}, 'required': ['max_freq', 'Ec', 'd', 'v_per_phi0', 'flux_offset']}, 'driving': {'type': 'object', 'title': 'driving', 'properties': {'drag_gaussian': {'type': 'object', 'title': 'drag_gaussian', 'properties': {'length': {'type': 'number', 'description': 'The pulse length [s]'}, 'sigma': {'type': 'number', 'description': 'The gaussian standard deviation (only for gaussian pulses) [s]'}, 'alpha': {'type': 'number', 'description': 'The DRAG coefficient alpha.'}, 'detuning': {'type': 'integer', 'description': 'The frequency shift to correct for AC stark shift [Hz].'}, 'shape': {'type': 'string', 'description': 'Shape of the gate'}, 'angle2volt': {'type': 'object', 'title': 'angle2volt', 'properties': {'deg90': {'type': 'number'}, 'deg180': {'type': 'number'}, 'deg360': {'type': 'number'}}, 'required': ['deg90', 'deg180', 'deg360']}}, 'required': ['length', 'sigma', 'alpha', 'detuning', 'shape', 'angle2volt']}, 'drag_cosine': {'type': 'object', 'title': 'drag_cosine', 'properties': {'length': {'type': 'number', 'description': 'The pulse length [s]'}, 'alpha': {'type': 'number', 'description': 'The DRAG coefficient alpha.'}, 'detuning': {'type': 'integer', 'description': 'The frequency shift to correct for AC stark shift [Hz].'}, 'shape': {'type': 'string', 'description': 'Shape of the gate'}, 'angle2volt': {'type': 'object', 'title': 'angle2volt', 'properties': {'deg90': {'type': 'number'}, 'deg180': {'type': 'number'}, 'deg360': {'type': 'number'}}, 'required': ['deg90', 'deg180', 'deg360']}}, 'required': ['length', 'alpha', 'detuning', 'shape', 'angle2volt']}, 'drag_cosine_f12': {'type': 'object', 'title': 'drag_cosine_f12', 'properties': {'length': {'type': 'number', 'description': 'The pulse length [s]'}, 'alpha': {'type': 'number', 'description': 'The DRAG coefficient alpha.'}, 'detuning': {'type': 'integer', 'description': 'The frequency shift to correct for AC stark shift [Hz].'}, 'shape': {'type': 'string', 'description': 'Shape of the gate'}, 'angle2volt': {'type': 'object', 'title': 'angle2volt', 'properties': {'deg90': {'type': 'number'}, 'deg180': {'type': 'number'}, 'deg360': {'type': 'number'}}, 'required': ['deg90', 'deg180', 'deg360']}}, 'required': ['length', 'alpha', 'detuning', 'shape', 'angle2volt']}, 'square': {'type': 'object', 'title': 'square', 'properties': {'length': {'type': 'number', 'description': 'The pulse length [s]'}, 'shape': {'type': 'string', 'description': 'Shape of the gate'}, 'angle2volt': {'type': 'object', 'title': 'angle2volt', 'properties': {'deg90': {'type': 'number'}, 'deg180': {'type': 'number'}, 'deg360': {'type': 'number'}}, 'required': ['deg90', 'deg180', 'deg360']}}, 'required': ['length', 'shape', 'angle2volt']}, 'flattop_cosine': {'type': 'object', 'title': 'flattop_cosine', 'properties': {'length': {'type': 'number', 'description': 'The pulse length [s]'}, 'rise_fall_length': {'type': 'number', 'description': 'The rise and fall duration [s]'}, 'shape': {'type': 'string', 'description': 'Shape of the gate'}, 'angle2volt': {'type': 'object', 'title': 'angle2volt', 'properties': {'deg90': {'type': 'number'}, 'deg180': {'type': 'number'}, 'deg360': {'type': 'number'}}, 'required': ['deg90', 'deg180', 'deg360']}}, 'required': ['length', 'rise_fall_length', 'shape', 'angle2volt']}}, 'required': ['drag_gaussian', 'drag_cosine', 'drag_cosine_f12', 'square', 'flattop_cosine']}, 'wiring': {'type': 'object', 'title': 'wiring', 'properties': {'drive_line_index': {'type': 'integer'}, 'correction_matrix': {'type': 'object', 'title': 'correction_matrix', 'properties': {'gain': {'type': 'number'}, 'phase': {'type': 'number'}}, 'required': ['gain', 'phase']}, 'maximum_amplitude': {'type': 'number', 'description': 'max amplitude in volts above which the mixer will send higher harmonics.'}, 'flux_line': {'type': 'object', 'title': 'flux_line', 'properties': {'controller': {'type': 'string'}, 'channel': {'type': 'integer'}, 'offset': {'type': 'number'}}, 'required': ['controller', 'channel', 'offset']}, 'flux_filter_coefficients': {'type': 'object', 'title': 'flux_filter_coefficients', 'properties': {'feedforward': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'feedback': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['feedforward', 'feedback']}}, 'required': ['drive_line_index', 'correction_matrix', 'maximum_amplitude', 'flux_line', 'flux_filter_coefficients']}, 'flux_bias_points': {'type': 'array', 'items': {'type': 'object', 'title': 'flux_bias_point', 'properties': {'name': {'type': 'string'}, 'value': {'type': 'number', 'description': 'Bias voltage to set qubit to maximal frequency [V]'}}, 'required': ['name', 'value']}}, 'sequence_states': {'type': 'object', 'title': 'sequence_states', 'properties': {'constant': {'type': 'array', 'items': {'type': 'object', 'title': 'constant', 'properties': {'name': {'type': 'string'}, 'amplitude': {'type': 'number', 'description': '[V]'}, 'length': {'type': 'number', 'description': '[s]'}}, 'required': ['name', 'amplitude', 'length']}}, 'arbitrary': {'type': 'array', 'items': {'type': 'object', 'title': 'arbitrary', 'properties': {'name': {'type': 'string'}, 'waveform': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': 'points describing the waveform shape'}}, 'required': ['name', 'waveform']}}}, 'required': ['constant', 'arbitrary']}}, 'required': ['index', 'name', 'f_01', 'f_12', 'anharmonicity', 'rabi_freq', 'rabi_conversion_factor', 't1', 't2', 't2echo', 't2star', 'ramsey_det', 'two_point_ramsey', 'transmon_spectrum', 'driving', 'wiring', 'flux_bias_points', 'sequence_states']}}, 'flux_bias_lookup_table': {'type': 'array', 'items': {'type': 'object', 'title': 'flux_bias_lookup_table', 'properties': {'dc_offset': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'f_01': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'resonator_frequency': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'pi_amplitude': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'readout_frequency': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['dc_offset', 'f_01', 'resonator_frequency', 'pi_amplitude', 'readout_frequency']}}, 'crosstalk_matrix': {'type': 'object', 'title': 'crosstalk_matrix', 'properties': {'static': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'fast': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['static', 'fast']}, 'single_qubit_operations': {'type': 'array', 'items': {'type': 'object', 'title': 'single_qubit_operation', 'properties': {'direction': {'type': 'string'}, 'angle': {'type': 'integer'}}, 'required': ['direction', 'angle']}}, 'dummy': {'type': 'integer', 'description': 'dum dum give me some gum gum'}, 'two_qubit_gates': {'type': 'object', 'title': 'two_qubit_gates', 'properties': {'CZ': {'type': 'array', 'items': {'type': 'object', 'title': 'CZ', 'properties': {'conditional_qubit': {'type': 'integer'}, 'target_qubit': {'type': 'integer'}, 'flux_pulse': {'type': 'object', 'title': 'flux_pulse', 'properties': {'constant': {'type': 'object', 'title': 'constant', 'properties': {'name': {'type': 'string'}, 'amplitude': {'type': 'number'}, 'length': {'type': 'number'}}, 'required': ['name', 'amplitude', 'length']}, 'arbitrary': {'type': 'object', 'title': 'arbitrary', 'properties': {'name': {'type': 'string'}, 'waveform': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}, 'description': 'points describing the waveform shape'}}, 'required': ['name', 'waveform']}}, 'required': ['constant', 'arbitrary']}}, 'required': ['conditional_qubit', 'target_qubit', 'flux_pulse']}}}, 'required': ['CZ']}, 'noise_pulses': {'type': 'object', 'title': 'noise_pulses', 'properties': {'n_pulses': {'type': 'integer'}, 'amplitude': {'type': 'integer'}, 'bandwidth': {'type': 'number'}, 'seed': {'type': 'integer'}}, 'required': ['n_pulses', 'amplitude', 'bandwidth', 'seed']}, 'results': {'type': 'object', 'title': 'results', 'properties': {'directory': {'type': 'string'}}, 'required': ['directory']}, 'running_strategy': {'type': 'object', 'title': 'running_strategy', 'properties': {'running': {'type': 'boolean'}, 'start': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}, 'end': {'type': 'array', 'items': {'anyOf': [{'type': 'integer'}, {'type': 'number'}, {'type': 'string'}, {'type': 'boolean'}, {'type': 'array'}]}}}, 'required': ['running', 'start', 'end']}, 'state_name': {'type': 'string'}, 'directory': {'type': 'string'}}, 'required': ['network', 'controllers', 'digital_waveforms', 'common_operation', 'readout_lines', 'readout_resonators', 'drive_lines', 'qubits', 'flux_bias_lookup_table', 'crosstalk_matrix', 'single_qubit_operations', 'dummy', 'two_qubit_gates', 'noise_pulses', 'results', 'running_strategy', 'state_name', 'directory']}
        self._freeze_attributes = True
    ...
    def dummy(self) -> int:
        ...
        value = self._quam._json[self._path + "dummy"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    @dummy.setter
    def dummy(self, value: int):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "dummy")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "dummy"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "dummy"] = value

    @property
    def state_name(self) -> str:
        """"""
        
        value = self._quam._json[self._path + "state_name"]
        for i in range(len(self._index)):
            value = value[self._index[i]]
        return value
    ...
    def state_name(self, value: str):
        """"""
        if self._quam._record_updates:
            self._quam._updates["keys"].append(self._path + "state_name")
            self._quam._updates["indexes"].append(self._index)
            self._quam._updates["values"].append(value)
        if (len(self._index) > 0):
            value_ref = self._quam._json[self._path + "state_name"]
            for i in range(len(self._index)-1):
                value_ref = value_ref[self._index[i]]
            value_ref[self._index[-1]] = value
        else:
            self._quam._json[self._path + "state_name"] = value
    ...
    @property
    def flux_bias_lookup_table(self) -> Flux_bias_lookup_tableList:
        """"""
        return Flux_bias_lookup_tableList(
            self._quam, self._path + "flux_bias_lookup_table", self._index,
            self._schema["properties"]["flux_bias_lookup_table"]
        )
    ...
    @property
    def noise_pulses(self) -> Noise_pulses:
        """"""
        return Noise_pulses(
            self._quam, self._path + "noise_pulses/", self._index,
            self._schema["properties"]["noise_pulses"]
        )
    @noise_pulses.setter
    def noise_pulses(self, value: dict):
        import opx_control.quam_sdk.crud
        quam_sdk.crud.replace_layer_in_quam_data(self, "noise_pulses", value)
    ...
    def get_flattop_readout_length(self, index: int) -> int:
        """"""
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.get_flattop_readout_length(self, index)

    def get_qubit_frequency_from_dc_bias(self, index: int, dc_bias: float) -> float:
        """
    Get the qubit frequency from the dc offset.

    :param index: index of the qubit to be retrieved.
    :return: the qubit frequency in Hz.
    """
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.get_qubit_frequency_from_dc_bias(self, index, dc_bias)

    def get_resonator_frequency_from_dc_bias(self, index: int, dc_bias: float) -> float:
        """
    Get the qubit frequency from the dc offset.
    ...
    """
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.get_resonator_frequency_from_dc_bias(self, index, dc_bias)

    def get_readout_frequency_from_dc_bias(self, index: int, dc_bias: float) -> float:
        """
    Get the qubit frequency from the dc offset.
    ...
    """
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.get_readout_frequency_from_dc_bias(self, index, dc_bias)

    def get_pi_amplitude_from_dc_bias(self, index: int, dc_bias: float) -> float:
        """
    Get the qubit frequency from the dc offset.
    ...
    """
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.get_pi_amplitude_from_dc_bias(self, index, dc_bias)

    def config_octave(self, qb_list: list[int], qm, calibrate_mixers: bool = False):
        """"""
        with _add_path(os.path.dirname(os.path.abspath(__file__))):
            import config
        return config.config_octave(self, qb_list, qm, calibrate_mixers)
