...
# machine = QuAM(r"C:\Users\T5_2\Desktop\quantum machines demo\data20230215\161444_state_after_Rabi frequency.json")
# machine = QuAM(r"C:\Users\T5_2\Desktop\quantum machines demo\data20230210\165734_state_after_protective_freq_vs_theta.json")

gate_shape = "drag_cosine"
# gate_shape = "flattop_cosine"
...
reset_method = "active"  # "cooldown" or "active" or "mixed"

# Hand tuning frequency for symmetry in protective experiment
# machine.readout_resonators[0].f_opt = machine.readout_resonators[0].f_res - machine.readout_resonators[0].chi * 0.9


# machine.readout_resonators[0].integration_weights[0].cosine = (
#     machine.readout_resonators[0].integration_weights[0].cosine[::4]
# )
# machine.readout_resonators[0].integration_weights[0].sine = (
#     machine.readout_resonators[0].integration_weights[0].sine[::4]
# )
# machine.readout_resonators[0].integration_weights[1].cosine = (
#     machine.readout_resonators[0].integration_weights[1].cosine[::4]
# )
# machine.readout_resonators[0].integration_weights[1].sine = (
#     machine.readout_resonators[0].integration_weights[1].sine[::4]
# )
# machine.readout_resonators[0].integration_weights[2].cosine = (
#     machine.readout_resonators[0].integration_weights[2].cosine[::4]
# )
# machine.readout_resonators[0].integration_weights[2].sine = (
#     machine.readout_resonators[0].integration_weights[2].sine[::4]
# )

# machine.readout_resonators[0].integration_weights[0].cosine = [1] * 250
# machine.readout_resonators[0].integration_weights[0].sine = [0] * 250
# machine.readout_resonators[0].integration_weights[1].cosine = [0] * 250
# machine.readout_resonators[0].integration_weights[1].sine = [1] * 250
# machine.readout_resonators[0].integration_weights[2].cosine = [0] * 250
# machine.readout_resonators[0].integration_weights[2].sine = [-1] * 250
