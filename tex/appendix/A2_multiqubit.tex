\chapter{Generalization of Dispersive Model for Multi Level Qubit}
...
\end{equation}
where the shifts from the higher order terms have been absorbed into the new redefined frequencies. \todo{This alters the dispersive shift, when we consider the three state (or higher) qubit. Maybe we need some considerations for this... We also just need to write out what the shifts are.}
