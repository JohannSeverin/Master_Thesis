...
\marginnote{This works as the time-evolution operator is given by $U = \exp(i\int dt H)$ so fast oscillating term will cancel if the time interval is sufficiently large.}
...
\end{equation}
\todo{This is Heisenberg picture, do we need the equation somewhere?}
...
\todo{Include legend in the figure}
\begin{figure}
    \centering
