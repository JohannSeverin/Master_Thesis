...
\todo{How exactly do we do this section. Do we just scan the detuning $\omega_{01}$ frequency or should we cover the steady state?}
...
\begin{figure}
    \centering
    \missingfigure{Rabi plot and fit}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
...
% It is possible to speed-up $T_1$
