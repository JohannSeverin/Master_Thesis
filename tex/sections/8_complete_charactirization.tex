...
\begin{figure}[h]
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[height = 0.55 \textheight]{Simulations/simulations_of_calibrations/Figs/qubit_T1.pdf}
    \end{minipage}
        \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[height = 0.55 \textheight]{Simulations/simulations_of_calibrations/Figs/resonator_spectroscopy.pdf}
    \end{minipage}
...
\begin{figure}
    \centering
    \includegraphics[]{Simulations/readout_simulations/figures/dispersive_approx.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
